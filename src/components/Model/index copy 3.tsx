  ...
  return (
    <>
      ...
      <Html
        ...
        occlude='blending'
      >
        <div className="skills w-[100vw] h-[100vh] relative pointer-events-none" ref={skills} >
          <About />
        </div>
      </Html>
      ...
      <Html
        ...
        occlude='blending'
      >
        <div className="w-[100vw] h-[100vh] relative pointer-events-none">
          <Education />
        </div>
      </Html>
...
// useGLTF.preload("https://sampada.dev/model/me6.glb");
