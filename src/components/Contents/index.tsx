...
const Contents = () => {
  return (
    <div className="w-full min-h-full bg-white">
      <section id='Home' className="home bg-gray-light w-full max-w-[92rem] h-[100vh] flex items-center justify-center">
        {/* <Introduction /> */}
      </section>
      ...
      <section id='Contact' className="contact bg-gray-light w-full max-w-[92rem] h-[100vh] flex items-center justify-center">
        <Contact />
      </section>
    </div>
  );
